...
ARG EXECUTABLE_KUBECTL=1.25.11
...
ADD https://storage.googleapis.com/kubernetes-release/release/v${EXECUTABLE_KUBECTL}/bin/linux/amd64/kubectl /usr/local/bin/kubectl
